...
static void CheckSHA1Sums(void)
{
    ...
    if (!correct_wad)
    {
        ...
        {
            printf("��������: ����������� ����� WAD-����� SHA1 �� ��������� � ���������:\n");
            PrintSHA1Digest("���������", net_local_wad_sha1sum);
            PrintSHA1Digest("���������", net_client_wait_data.wad_sha1sum);
        }
    }
    ...
    if (!correct_deh)
    {
        ...
        {
            printf("��������: ����������� ����� SHA1 ����� Dehacked �� ��������� � ���������:\n");
            PrintSHA1Digest("���������", net_local_deh_sha1sum);
            PrintSHA1Digest("���������", net_client_wait_data.deh_sha1sum);
        }
    }
